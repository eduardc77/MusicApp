...
var searchCategories = [
    ...
    SearchCategoryModel(image: "category1", title: "Classical", tag: 10),
    SearchCategoryModel(image: "category2", title: "Chill", tag: 11),
    SearchCategoryModel(image: "category3", title: "Dance", tag: 12),
    SearchCategoryModel(image: "category4", title: "Alternative", tag: 13),
    SearchCategoryModel(image: "category5", title: "Focus", tag: 14),
    SearchCategoryModel(image: "category6", title: "Kids", tag: 15),
    SearchCategoryModel(image: "category7", title: "Romance", tag: 16),
    SearchCategoryModel(image: "category8", title: "Dj Mixes", tag: 17),
    SearchCategoryModel(image: "category9", title: "Sleep", tag: 18),
    SearchCategoryModel(image: "category10", title: "R&B/Soul", tag: 19),
